...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro v2.4.3-dev (Voron M4)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -5, -1.94 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 30, 30, 32, 30 } // (mm) Left, Front, Right, Back insets
