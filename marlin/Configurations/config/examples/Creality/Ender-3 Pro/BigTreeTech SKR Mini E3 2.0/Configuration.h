...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro v2.3-dev"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -5, -2.03 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { 2, -5, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 50, -26, (Z_MIN_POS + 1) } }
